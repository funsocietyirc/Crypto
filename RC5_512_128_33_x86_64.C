// #fsociety @ freenode
// RC5 (64bit, 33 Rounds, 512bit key, 128bit block)
...
#define t        68             /* size of table S = 2*(r+1) words   */
...
int main() {
  ...
  printf("RC5 (64bit, 33 Rounds, 512bit key, 128bit block):\n");
  for (i=1;i<6;i++) {
    ...
    printf("\n   P: %016llX %016llX  =>  C: %016llX %016llX => dP: %016llX %016llX\n", pt1[0], pt1[1], ct[0], ct[1], pt2[0], pt2[1]);
    if (pt1[0] != pt2[0] || pt1[1] != pt2[1]) {
      printf("\n DECRYPT ERROR: %016llX %016llX != %016llX %016llX \n", pt1[0], pt1[1], pt2[0], pt2[1]);
    }
  }
  /*
  time (&t0);
